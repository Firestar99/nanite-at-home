use space_engine_shader::renderer::lod_obj::opaque_model::OpaqueModel;
use space_engine_shader::renderer::lod_obj::opaque_shader::Params;
use std::ops::Deref;
use std::sync::Arc;
...
use crate::shader::renderer::lod_obj::opaque_shader;
